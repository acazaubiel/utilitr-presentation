...
```
---
# Limites et perspectives du tidyverse

Le tidyverse présente de nombreux avantages mais aussi deux limites principales :

1. Il n'est pas très efficace (d'autres manières de faire sont plus puissantes et économes en ressources) => éviter de manipuler des fichiers > 1Go
2. Il est très facile de faire 90% des opérations... et assez difficile de faire les 10% restants !!

Mais c'est un élément central de l'éco-système de `R` : je vous invite donc à lire les fiches [Manipuler les données avec {data.table}](https://www.book.utilitr.org/datatable.html) et [Faire des graphiques avec {ggplot2}](https://www.book.utilitr.org/ggplot2.html)
